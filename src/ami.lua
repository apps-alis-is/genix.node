    ...
    commands = {
        ...
        validate = {
            ...
            action = function(_options, command, args, cli)
                ...
                -- //TODO: add switches
                ami_assert(proc.EPROC, "GENIX node AMI requires extra api - eli.proc.extra", EXIT_MISSING_API)
                ami_assert(fs.EFS, "GENIX node AMI requires extra api - eli.fs.extra", EXIT_MISSING_API)
                ...
                log_success("GENIX node configuration validated.")
            end
        },
        about = {
