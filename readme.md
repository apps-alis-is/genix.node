...
2. Create directory for your application (it should not be part of user home folder structure, you can use for example `/mns/genix1`)
...
`ami --path=/mns/genix1 -ll=trace setup`